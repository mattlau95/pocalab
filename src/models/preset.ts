...
export const PRESETS: Record<PrintPreset['id'], PrintPreset> = {
  'letter':  { id: 'letter',  label: 'US Letter',   sheetMm: { w: 215.9, h: 279.4 }, cols: 3, rows: 3, orientation: 'landscape', bleedMm: 2,   nUp: 9 },
  'a4':      { id: 'a4',      label: 'A4',          sheetMm: { w: 210,   h: 297   }, cols: 3, rows: 3, orientation: 'landscape', bleedMm: 2,   nUp: 9 },
